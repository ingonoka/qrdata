...
https://github.com/ingonoka/qrdata[QR Data Analyzer] (C) by https://afcsblog.ingonoka.com/about/[Ingo Noka] is licensed under https://creativecommons.org/licenses/by-nc-nd/4.0/[CC BY-NC-ND 4.0] image:https://mirrors.creativecommons.org/presskit/icons/cc.svg[CC, fit=line] image:https://mirrors.creativecommons.org/presskit/icons/by.svg[By, fit=line] image:https://mirrors.creativecommons.org/presskit/icons/nc.svg[Nc, fit=line] image:https://mirrors.creativecommons.org/presskit/icons/nd.svg[nd, fit=line]
